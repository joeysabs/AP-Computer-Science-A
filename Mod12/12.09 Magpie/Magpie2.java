...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if (findKeyword(statement, "weird") >= 0)
        {
          response = "Yeah that is weird.";
        }
        ...
        {
          response = "Did you know that phones are like cousins to computers?";
        }
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "You're crazy dog.";
        }
        else if (whichResponse == 5)
        {
            response = "Wow really that's crazy bro.";
        }
